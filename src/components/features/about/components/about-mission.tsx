      ...
      <Container>
        <div className='relative mx-auto max-w-3xl text-center'>
          ...
          <p className='relative text-2xl leading-snug tracking-tight text-gray-700'>
            ...
            нужно. Мы делаем AgroZone, чтобы находить друг друга было проще: понятные категории под сельхозтехнику,
            продукцию и услуги, фильтры по тем параметрам, которые реально важны в этой сфере, и модерация каждого
            объявления — чтобы каталог оставался тем местом, где можно спокойно вести дела.
          </p>
        </div>
      </Container>
    </section>
