...
const override = "data-open:slide-in-from-bottom-8 data-closed:slide-out-to-bottom-8 top-16 right-0 bottom-0 left-0 flex max-w-none translate-x-0 translate-y-0 flex-col gap-0 overflow-hidden rounded-t-2xl rounded-b-none p-0"
